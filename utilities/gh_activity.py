...
"""
Usage:
python3 activity_gen.py --max_commits=15 --frequency=25 --days_before=1095 \
--repository=git@github.com:bharathpatnaik/watch-tower.git

Rules,
- Need to choose a new repo that hasn't been initialised
- Generates 1 year's worth of history - tweak #51 to change this behaviour
"""
import argparse
import os
